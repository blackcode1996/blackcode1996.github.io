...
//chatify
import c_homepage from "../Aseests/ProjectsSnaps/Chatify/HomePage_Pc.png";
import c_signup from "../Aseests/ProjectsSnaps/Chatify/SignUp_page_pc.png";
import c_login from "../Aseests/ProjectsSnaps/Chatify/LoginPage_pc.png";
import c_chatpage from "../Aseests/ProjectsSnaps/Chatify/Chatpage_pc.png";
//npm package
import n_pic_1 from "../Aseests/ProjectsSnaps/Npm/npm_package_pic1.png";
import n_pic_2 from "../Aseests/ProjectsSnaps/Npm/npm_package_pic1.png";
import n_pic_3 from "../Aseests/ProjectsSnaps/Npm/npm_package_pic1.png";
...
const projectsData = [
  ...
  },
  {
    ...
    title: "Tripguru",
    description:
      "It is a travel planning and booking application that helps users plan and book their dream vacations.",
    subdescription:
      "A collaborative project of 5 members built in a span of 5 days",
  ...
  },
  {
    ...
    title: "Chatify",
    description:
      "It is a real time chat app where users can communicate in real time.",
    subdescription: "A individual project built in a span of 10 days",
    techStack: [
      "ReactJs",
      "JavaScript",
      "CSS",
    ...
    deployedURL: "https://chatapp-orcin-two.vercel.app/",
    githubURL: "https://github.com/blackcode1996/Chatify",
    images: [c_homepage, c_signup, c_login, m_singapore, c_chatpage],
  },
  {
    id: 4,
    title: "NPM Package",
    description: "It is npm package built to generate random OTP and password.",
    subdescription: "A individual project built in a span of 3 days",
    techStack: ["NPM", "JavaScript", "TypeScript"],
    deployedURL: "https://www.npmjs.com/package/simple-otp-generator",
    githubURL: "https://github.com/blackcode1996/simple-otp-generator",
    images: [n_pic_1, n_pic_2, n_pic_3],
  },
  {
    id: 5,
    title: "Airbnb",
    description:
      "It is a company that operates an online marketplace for short-term homestays and experiences.",
    subdescription:
      "A collaborative project of 2 members built in a span of 20 days",
  ...
  },
  {
    ...
    title: "Formal Click",
    description:
      "It is a clone of Tata Cliq website which we named as Formal Click. Tata Cliq is an Indian e-commerce company based in Mumbai, India.",
